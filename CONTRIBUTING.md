...
- **Frontend (Next.js/React) :**
  ...
  - [cite_start]Le développement doit être orienté _mobile first_[cite: 31, 50].
...
2.  **Développement & Tests :** Coder, tester (unitaires) et effectuer des _commits_ clairs (`feat:`, `fix:`, `docs:`) dans votre branche.
3.  **Pull Request (PR) :**
